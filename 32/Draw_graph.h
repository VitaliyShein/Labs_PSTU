...
Graph<int> makeGraph()
{
	...
	cout << "Введите количество рёбер графа: "; cin >> amountEdges; cout << endl;
	...
	for (int i = 0; i < amountEdges; ++i) {
		cout << "Введите значение исходной вершины: "; cin >> sourceVertex; cout << endl;
		int* sourceVertPtr = &sourceVertex;
		cout << "Введите значение конечной вершины: "; cin >> targetVertex; cout << endl;
		int* targetVertPtr = &targetVertex;

		cout << "Введите вес ребра: "; cin >> edgeWeight; cout << endl;
...
void mouseClick(int btn, int stat, int x, int y) {
	...
	if (stat == GLUT_DOWN) {
		...
		if (x > shift&& x < shift + 135 && y >  shift  && y < shift + 30)
		{
			...
			cout << "Введите номер вершины: "; cin >> sourceVertex; cout << endl;
			int* sourceVertPtr = &sourceVertex;
			cout << "Введите номер вершины с которой будет связана новая вершина: "; cin >> targetVertex; cout << endl;
			int* targetVertPtr = &targetVertex;
		...
		if (x > shift&& x < shift + 135 && y > shift + 40 && y < shift + 70)
		{
			...
			cout << "Укажите номер удаляемой вершины: "; cin >> sourceVertex; cout << endl;
			int* sourceVertPtr = &sourceVertex;
			...
			else cout << "Такой вершины нет в графе\n";
		}
...
void display()
{
	...
	glClearColor(0.831,0.831,0.851, 1.0);
